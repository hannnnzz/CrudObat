...
router.get("/", authentication_mdl.is_login, function (req, res, next) {
  req.getConnection(function (err, connection) {
    var query = connection.query("SELECT * FROM drug", function (err, rows) {
...
router.get("/info/(:id)", authentication_mdl.is_login, function (req, res, next) {
  req.getConnection(function (err, connection) {
    var query = connection.query("SELECT * FROM drug where id=" + req.params.id, function (err, rows) {
      if (err) var errornya = ("Error Selecting : %s ", err);
      req.flash("msg_error", errornya);
...
router["delete"]("/delete/(:id)", authentication_mdl.is_login, function (req, res, next) {
  req.getConnection(function (err, connection) {
    ...
    req.getConnection(function (err, connection) {
      var query = connection.query(delete_sql, drug, function (err, result) {
        if (err) {
...
router.put("/edit/(:id)", authentication_mdl.is_login, function (req, res, next) {
  ...
  if (!errors) {
    ...
    req.getConnection(function (err, connection) {
      var query = connection.query(update_sql, drug, function (err, result) {
        if (err) {
...
router.post("/add", authentication_mdl.is_login, function (req, res, next) {
  ...
  if (!errors) {
    ...
    req.getConnection(function (err, connection) {
      var query = connection.query(insert_sql, drug, function (err, result) {
        if (err) {
